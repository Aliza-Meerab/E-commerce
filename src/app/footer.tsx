...
const Footer = () => {
  return (
    < >
      <div className='px-6 md:px-12 py-10 bg-[#2A254B] mt-16 w-full abxolute left-0 right-0 top-10'>
        <div className="flex flex-wrap gap-12 md:gap-[100px] lg:gap-[200px]">
          {/* Menu Section */}
          <div className="text-white w-full sm:w-auto">
            <h1 className="text-lg md:text-xl font-bold pb-4 text-left">Menu</h1>
          ...
          {/* Categories Section */}
          <div className="text-white w-full sm:w-auto">
            <h1 className="text-lg md:text-xl font-bold pb-4">Categories</h1>
            <div className='space-y-2 text-left'>
          ...
          {/* Company Section */}
          <div className="text-white w-full sm:w-auto">
            <h1 className="text-lg md:text-xl font-bold pb-4">Our Company</h1>
            <div className='space-y-2 text-left'>
          ...
          <div className="text-white w-full sm:w-auto">
            ...
            <div className='mt-4'>
              <input
                ...
                className='w-full sm:w-[250px] lg:w-[300px] h-[48px] p-2 bg-transparent opacity-35 border border-white rounded-md text-white'
              />
